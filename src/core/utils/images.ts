 ...
 */
export function getFrontCover(movie: MovieDto): null | string {
 ...
 */
export function getFullCover(movie: MovieDto): null | string {
 ...
 */
export function getProfile(person: PersonDto): null | string {
